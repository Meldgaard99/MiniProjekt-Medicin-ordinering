...
public class ServiceTest
{
    ...
    public void dagligFastTest1()
    {
        ...
        double DagligFastTestCase1 = Test1.samletDosis();


        Assert.AreEqual("Henrik Hansen", patient.navn);
        Assert.AreEqual(49, DagligFastTestCase1);
        Assert.AreEqual(7, (Test1.slutDen.Day - Test1.startDen.Day + 1));
    }
    ...
    public void dagligFastTest2()
    {
        ...
        Patient patient = service.GetPatienter().FirstOrDefault(p => p.PatientId == 1)!;

        DagligFast Test2 = new DagligFast(new DateTime(2023, 05, 20), new DateTime(2023, 09, 12), new Laegemiddel("Pencilin", 0.1, 0.15, 0.16, "Styk"), 4, 2, 1, 0);

       //  double DagligFastTestCase2 = Test2.doegnDosis();
